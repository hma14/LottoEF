...
class OZLottoWed(Lottotry):
	
	def __init__(self, tbl):
		super(OZLottoWed, self).__init__(tbl)
				
		driver = self.driver
		driver.get("http://tatts.com/nswlotteries/results/last-10-results?product=Monday%20Wednesday%20Lotto")
